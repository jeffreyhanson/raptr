...
& & & & & 0 \leq s \leq S-1\\
%
& & & \sum{j=0}^{J-1} Y_{fsij} = 1 & \forall & 0 \leq f \leq F-1, \tag{2d}\\
& & & & & 0 \leq s \leq S-1, \\
& & & & & 0 \leq i \leq I-1\\
%
...
& & & & & 0 \leq s \leq S-1\\
%
& & & \sum_{j=0}^{J-1} Y_{fsijr} + \sum_{s=0}^{r-1} Y_{fiJs} & \forall & 0 \leq f \leq F-1, \tag{5b}\\
& & & & & 0 \leq s \leq S-1,\\
& & & & & 0 \leq i \leq I-1,\\
& & & & & 0 \leq r \leq R\\
%
& & & \sum_{r=0}^{R-1} Y_{fsijr} \leq X_j & \forall & 0 \leq f \leq F-1, \tag{5c}\\
& & & & & 0 \leq s \leq S-1,\\
& & & & & 0 \leq i \leq I-1,\\
& & & & & 0 \leq j \leq J-1\\
%
& & & \sum_{r=0}^{R} Y_{fsijr} = 1 & \forall & 0 \leq f \leq F-1, \tag{5d}\\
& & & & & 0 \leq s \leq S-1,\\
& & & & & 0 \leq i \leq I-1\\
%
& & & P_{fsij0} = q_{fj} & \forall & 0 \leq f \leq F-1, \tag{5e}\\
& & & & & 0 \leq s \leq S-1,\\
& & & & & 0 \leq i \leq I-1,\\
& & & & & 0 \leq j \leq J\\
%
& & & P_{fsijr} = \left(1 - \right) \sum_{k=0}^{J-1} \frac{1 - q_k}{q_k} P_{f,s,i,k,r-1} Y_{f,s,i,k,r-1}  & \forall & 0 \leq f \leq F-1, \tag{5f}\\
& & & & & 0 \leq s \leq S-1,\\
& & & & & 0 \leq i \leq I-1,\\
& & & & & 0 \leq j \leq J,\\
& & & & & 1 \leq r \leq R\\
%
& & & X_j, Y_{fsijr} \in {0,1} & \forall & 0 \leq f \leq F-1, \tag{5g}\\
& & & & & 0 \leq s \leq S-1,\\
& & & & & 0 \leq i \leq I-1\\
& & & & & 0 \leq j \leq J\\
& & & & & 0 \leq r \leq R \\
...
The objective function for the reliable formulation is the as that for the unreliable formation (2a). Similar to the unreliable formulation, contraints (2b) and (5a) ensure that the amount-based and space-based targets are met. Constraint (5b) ensures that the imaginary planning unit $j=J+1$ is never selected to yield correct boundary length calculations. Constraints (5c) ensure that only selected planning units are assigned to demand points $i \in I$. Constraints (5d) ensure that only one planning unit is assigned to each demand point $i \in I$ at each $r$-level for each $f \in F$, $s \in S$. Constraints (5e--5f) determine the probability that planing unit $j$ will be used to sample demand point $i \in I$ for $s \in S$ and $f \in F$ [@r16]. Constraints (5g) ensure that the $X$ and $Y$ variables are binary.
...
### Prioritisations
To simplify the process of formatting data and generating prioritisations, we can use the `rap` function. First, we will generate an amount-based prioritisation that aims to capture 20% of the rosella's range. We will use 100 demand points to map the geographic and environmental spaces.
...
We can also see how well the prioritisation secures the species' distribution in the geographic and environmental attribute spaces.
...
Now, let's generate a prioritisation using amount- and space-based targets. This prioritisation will secure 85% of the species distribution in geographic and environmental space.
