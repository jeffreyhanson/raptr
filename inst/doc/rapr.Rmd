...
```{r, eval={is.GurobiInstalled(verbose=FALSE)}, cache=TRUE, fig.height=5.5, fig.width=5.5}
...
<!-- ```{r, eval={is.GurobiInstalled(verbose=FALSE)}, fig.height=5.5, fig.width=5.5} -->
```{r, eval=FALSE, fig.height=5.5, fig.width=5.5}
...
<!-- ```{r, eval={is.GurobiInstalled(verbose=FALSE)}, fig.height=5.5, fig.width=7.5} -->
