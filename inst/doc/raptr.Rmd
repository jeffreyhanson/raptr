...
```{r, fig.width=7, fig.height=4.5, fig.cap="_Distribution of three simulated species. Each square represents a planning unit. The color of each square denotes the probability that individuals from each species occupy it._"}
# plot species
plot(
...
To map the distribution of environmental conditions across the species' range, 21 [bioclimatic layers](https://worldclim.org) were obtained. These layers were cropped to Australia and subject to detrended correspondence analysis to produce two new variables. These layers are stored in the `cs_space` object.
...
```{r, fig.height=6.0, fig.width=10, fig.align='center', fig.cap="_Distribution of amount-based prioritization in the environmental attribute space. See Figure 28 caption for conventions._"}
...
```{r, fig.height=6.0, fig.width=10, fig.cap="_Distribution of the amount- and space-based prioritization in the geographic attribute space. See Figure 28 caption for conventions._"}
# plot prioritization in geographic attribute space
...
```{r, fig.height=6.0, fig.width=10, fig.align='center', fig.cap="_Distribution of the amount- and space-based prioritization in the environmental attribute space. See Figure 28 caption for conventions._"}
# plot prioritization in environmental attribute space
