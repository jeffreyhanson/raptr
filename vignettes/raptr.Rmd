...
We can see that a greater number of planning units is needed to satisfy the space-based targets. The prioritisation generated using just amount-based targets has `r n_cs_rs_amount` planning units, and the prioritisations using amount-based and space-based targets has `r n_cs_rs_space` planning units. These results suggest only a few additional planning units can result in significant improvements in the effectiveness of a prioritisation.
