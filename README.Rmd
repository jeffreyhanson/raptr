...
[![R-CMD-check-Fedora](https://img.shields.io/github/actions/workflow/status/jeffreyhanson/raptr/R-CMD-check-fedora.yaml?branch=master&label=macOS)](https://github.com/jeffreyhanson/raptr/actions)
