...
#'
#' @param pus \code{\link[sp]{SpatialPolygons}} object representing planning units.
#' @param species \code{\link[raster]{raster}} object with species distribution data.
#' @param spaces \code{list} of \code{\link[raster]{raster}} objects. Each elements denotes the spatial distribution for each space. Defaults to \code{NULL}.
