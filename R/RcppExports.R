...
rcpp_dump_numeric_object <- function(x) {
    .Call('raptr_rcpp_dump_numeric_object', PACKAGE = 'raptr', x)
}

rcpp_dump_integer_object <- function(x) {
    .Call('raptr_rcpp_dump_integer_object', PACKAGE = 'raptr', x)
}

rcpp_dump_character_object <- function(x) {
    .Call('raptr_rcpp_dump_character_object', PACKAGE = 'raptr', x)
}
