...
#'   \item \code{\link{RapReliableOpts-class}}: parameters for the reliable formulation of RASP.
#'   \item \code{\link{RapUnreliableOpts-class}}: parameters for the unreliable formulation of RASP.
#'   \item \code{\link{RapData-class}}: planning unit, species data, and demand points for RASP.
#'   \item \code{\link{RapUnsolved-class}}: contains all the data and input parameters required to generate prioritisations using RASP. This class contains a \code{\link{GurobiOpts-class}} object, a \code{\link{RapReliableOpts-class}} or \code{\link{RapUnreliableOpts-class}} object, and a \code{\link{RapData-class}} object.
